...
path_agent = get_project_path() + 'models/train/cstm_pi/mirr_py/StraightMimicWalker/1envs/8mio/362'
PATH = path_agent
...
checkpoint = '24_min15mean15' # 'ep_ret2100_20M' # '33_min24mean24' # 'ep_ret2000_7M' #'mean_rew60'
...
if FROM_PATH and not PLAYBACK_TRAJECS:
    ...
    env = load_env(checkpoint, PATH, cfgl.ENV_ID)
else:
